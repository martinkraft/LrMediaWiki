...
return {
	...
	metadataFieldsForPhotos = {
		...
		{
			id = 'textGeneratorTemplate',
			version = 1,
			title = LOC "$$$/LrMediaWiki/Metadata/TextGeneratorTemplateTooltip=Text Generator Template^n^nTemplate for generating text from the photo metadata",
			dataType = 'string',
			searchable = false,
			browsable = false,
		},
